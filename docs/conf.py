...
"""
tintin documentation build configuration file.
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/tintin",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'tintin'),
                os.path.join(root_path, 'tintin/migrations')])
