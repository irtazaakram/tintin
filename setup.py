...
VERSION = get_version('tintin', '__init__.py')
...
setup(
    ...
    url='https://github.com/openedx/tintin',
    packages=find_packages(
        include=['tintin', 'tintin.*'],
        exclude=["*tests"],
    ),
    ...
    package_data=package_data("tintin", ["static", "public"]),
